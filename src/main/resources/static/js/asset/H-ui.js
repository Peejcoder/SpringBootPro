...
!(function(factory) {
	if (typeof define === 'function' && define.amd) {
		...
		define(['static/js/asset/jquery'], factory);
	} else if (typeof exports === 'object') {
		// Node/CommonJS
		module.exports = factory(require('static/js/asset/jquery'));
	} else {
		// Browser globals
		factory(jQuery);
	}
...
(function(root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		var jQuery;
		try {
			jQuery = require("static/js/asset/jquery");
		} catch(err) {
			jQuery = null;
		}
...
* ========================================================= */
! (function(factory) {
	if (typeof define === 'function' && define.amd) define(['static/js/asset/jquery'], factory);
	else if (typeof exports === 'object') factory(require('static/js/asset/jquery'));
	else factory(jQuery);
} (function($, undefined) {
