...
public class ExcelUtil {
    ...
    public static HSSFWorkbook createWorkBook(List<Map<String, Object>> list, String[] keys, String columnNames[]) {
        ...
        sheet.setColumnWidth((short) 3, (short) (50 * 60 *2));
        sheet.setColumnWidth((short) 4, (short) (50 * 60 *2));
        sheet.setColumnWidth((short) 6, (short) (50 * 60 *2));
        sheet.setColumnWidth((short) 7, (short) (50 * 60 *2));
